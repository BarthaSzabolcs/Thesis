...
//        private List<PropertyInfo> joinedTables = new List<PropertyInfo>();
...
//            {
//                if (coloumns[i].Value == DataTypes.ForeignKey)
//                {
//                    statement += $" {coloumns[i].Key.Name}Id  INTEGER";
//                }
//                else
//                {
